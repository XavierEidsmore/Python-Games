...
print("\nYou stumble out of the bathroom stall. WOW, you're so stinky.")
...
while (game_number_counter <= 3):
    ...
    -But if you shoot yourself with a gray shell, you take an extra turn.""")
        #Pause
        input("\nPress [Enter] to continue: ")
...
#Player turn-------------------------------------------------------------------------------------------
            ...
            while (inside_choice_loop == True and player_turn_skipped == False and player_handcuffed == False):
